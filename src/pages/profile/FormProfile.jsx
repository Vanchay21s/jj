...
const FormProfile = () => {
    const {profile, success, setSuccess, loading, error} = useProfile()
    ...
    return (
        ...
        <div className="flex flex-col gap-5 mt-[36px]">
            <form className='w-full bg-[#111118] py-4 px-6 rounded-md border-t-3 border-[#7C6AF8]'>
                ...
                <div className='flex gap-5'>
                    ...
                    <div className='flex flex-col justify-center items-start gap-5'>
                        <button className="w-full p-3 rounded-sm text-[12px] text-[#06060C] bg-[#7C6AF7] font-bold cursor-pointer flex items-center justify-center gap-1">Change Picture</button>
                        <p className="text-[14px] mt-[-5px] text-[#55556A]">JPG, PNG or GIF. Max size 2MB</p>
                    </div>
                </div>
            </form>
            <form onSubmit={handleSubmit} className='flex flex-col gap-5 bg-[#111118] py-4 px-6 rounded-md border-t-3 border-[#7C6AF8]'>
                {/* fullname & username*/}
                <div className='flex gap-5'>
                    <div className='w-1/2'>
                ...
                <div className='flex gap-5'>
                    ...
                    <button className="w-full p-3 rounded-sm text-[12px] text-[#06060C] bg-[#7C6AF7] font-bold cursor-pointer">Save Change</button>
                </div>
            </form>
        </div>
